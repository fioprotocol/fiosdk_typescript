...
class Transactions {
    ...
    executeCall(_a) {
        return __awaiter(this, arguments, void 0, function* ({ baseUrl, endPoint, body, fetchOptions, signal, returnBaseUrl = false, }) {
            var _b, _c;
            let options;
            this.validate();
            ...
            try {
                ...
                if (returnBaseUrl) {
                    return Object.assign(Object.assign({}, result), { baseUrl });
                }
                return result;
            }
            catch (e) {
    ...
    multicastServers(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield (0, utils_1.asyncWaterfall)({
                asyncFunctions: this.config.baseUrls.map((apiUrl) => (signal) => this.executeCall({ baseUrl: apiUrl, endPoint: endpoint, body, fetchOptions, signal, returnBaseUrl })),
                requestTimeout,
