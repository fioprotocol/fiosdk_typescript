...
class Transactions {
    ...
    getBlock(chain) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.multicastServers({ endpoint: 'chain/get_block', fetchOptions: {
                    body: JSON.stringify({
    ...
    multicastServers({ endpoint, body, fetchOptions, requestTimeout }) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield (0, utils_1.asyncWaterfall)({
                asyncFuncs: Transactions.baseUrls.map((apiUrl) => (signal) => this.executeCall({ baseUrl: apiUrl, endPoint: endpoint, body, fetchOptions, signal })),
                requestTimeout,
            });
            if (res.isError) {
