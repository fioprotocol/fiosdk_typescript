...
class RecordObtData extends SignedTransaction_1.SignedTransaction {
    constructor(fioRequestId, payerFIOAddress, payeeFIOAddress, payerPublicAddress, payeePublicAddress, amount, tokenCode, obtID, maxFee, status, walletFioAddress = '', payeeFioPublicKey, memo = null, hash = null, offLineUrl = null) {
        super();
