...
class RecordObtData extends SignedTransaction_1.SignedTransaction {
    constructor(fioRequestId, payerFioAddress, payeeFioAddress, payerPublicAddress, payeePublicAddress, amount, chainCode, tokenCode, obtID, maxFee, status, walletFioAddress = '', payeeFioPublicKey, memo = null, hash = null, offLineUrl = null) {
        super();
