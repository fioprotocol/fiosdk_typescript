...
class RecordObtDataRequest extends SignedRequest_1.SignedRequest {
    constructor(config, props) {
        ...
        this.getData = () => ({
            actor: this.getActor(),
            content: this.getCipherContent('record_obt_data_content', this.content, this.props.encryptPrivateKey || this.privateKey, this.props.payeeFioPublicKey),
        ...
        this.getResolvedContent = () => ({
            ...
            status: this.props.status || entities_1.FioRequestStatus.sent_to_blockchain,
            token_code: this.props.tokenCode,
        });
        this.getResolvedProps = (props) => {
            var _a, _b, _c, _d, _e, _f, _g;
            return (Object.assign(Object.assign({}, props), { encryptPrivateKey: (_a = props.encryptPrivateKey) !== null && _a !== void 0 ? _a : null, fioRequestId: (_b = props.fioRequestId) !== null && _b !== void 0 ? _b : 0, hash: (_c = props.hash) !== null && _c !== void 0 ? _c : null, memo: (_d = props.memo) !== null && _d !== void 0 ? _d : null, offLineUrl: (_e = props.offLineUrl) !== null && _e !== void 0 ? _e : null, payeeFioPublicKey: (_f = props.payeeFioPublicKey) !== null && _f !== void 0 ? _f : '', status: (_g = props.status) !== null && _g !== void 0 ? _g : '' }));
        };
