...
class Request {
    ...
    serialize(_a) {
        return __awaiter(this, arguments, void 0, function* ({ chainId, abiMap = Request.abiMap, transaction, textDecoder = utils_1.defaultTextDecoder, textEncoder = utils_1.defaultTextEncoder, }) {
    ...
    deserialize(_a) {
        return __awaiter(this, arguments, void 0, function* ({ chainId, abiMap = Request.abiMap, serializedTransaction, textDecoder = utils_1.defaultTextDecoder, textEncoder = utils_1.defaultTextEncoder, }) {
            const api = this.initFioJsApi({
                abiMap,
                chainId,
                privateKeys: [],
    ...
    sign(_a) {
        return __awaiter(this, arguments, void 0, function* ({ abiMap = Request.abiMap, chainId, privateKeys, transaction, serializedTransaction, serializedContextFreeData, }) {
