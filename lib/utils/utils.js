...
function getEncryptKeyForUnCipherContent({ getEncryptKey, method = '', payeeFioAddress, payerFioAddress, payeePublicKey, payerPublicKey, publicKey }) {
    return __awaiter(this, void 0, void 0, function* () {
        let encryptKey = null;
        ...
        if (payerFioAddress) {
            try {
                const payerEncryptKeyRes = yield getEncryptKey(payerFioAddress);
        ...
        if (payeeFioAddress) {
            try {
                const payeeEncryptKeyRes = yield getEncryptKey(payeeFioAddress);
