        ...
        try {
            for (let i = 0; i < asyncFunctions.length; i++) {
                ...
                try {
                    ...
                    clearTimeout(timeoutId);
                    if ((error === null || error === void 0 ? void 0 : error.code) && [constants_1.API_ERROR_CODES.NOT_FOUND, constants_1.API_ERROR_CODES.BAD_REQUEST].includes(error.code)
                        || (error === null || error === void 0 ? void 0 : error.errorCode) && [constants_1.API_ERROR_CODES.NOT_FOUND, constants_1.API_ERROR_CODES.BAD_REQUEST].includes(error.errorCode)) {
                        throw error;
                    }
