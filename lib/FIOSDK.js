...
exports.FIOSDK = exports.fioConstants = void 0;
const fiojs_1 = require("@fioprotocol/fiojs");
const entities_1 = require("./entities");
const queries = require("./transactions/queries");
const Request_1 = require("./transactions/Request");
const requests = require("./transactions/requests");
const SignedRequest_1 = require("./transactions/requests/SignedRequest");
const fioConstants = require("./utils/constants");
...
class FIOSDK {
    ...
    constructor() {
            ...
            apply(target, scope, args) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    const setAbi = (accountName) => __awaiter(this, void 0, void 0, function* () {
                        if (!Request_1.Request.abiMap.get(accountName)) {
                            const response = yield this.main.getAbi(accountName);
                            Request_1.Request.abiMap.set(response.account_name, response);
                        }
                    });
        ...
        const { privateKey, publicKey, apiUrls, fetchJson, registerMockUrl = '', technologyProviderId = '', returnPreparedTrx = false, } = (0, utils_1.resolveOptions)({
            arguments,
    ...
    executePreparedTrx(endPoint, preparedTrx) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield new Request_1.Request(this.config).multicastServers({
                body: JSON.stringify(preparedTrx),
                endpoint: `chain/${endPoint}`,
            });
            return SignedRequest_1.SignedRequest.prepareResponse(response, true);
        });
    }
    registerFioAddress() {
        ...
        const registerFioAddress = new requests.RegisterFioAddressRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
    ...
    registerFioDomainAddress(options) {
        ...
        const registerFioDomainAddress = new requests.RegisterFioDomainAddressRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
    ...
    registerFioDomain() {
        ...
        const registerFioDomain = new requests.RegisterFioDomainRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
    ...
    burnFioAddress() {
        ...
        const burnFioAddress = new requests.BurnFioAddressRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
    ...
    transferFioDomain() {
        ...
        const transferFioDomain = new requests.TransferFioDomainRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
    ...
    transferFioAddress() {
        ...
        const transferFioAddress = new requests.TransferFioAddressRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
    ...
    addBundledTransactions() {
        ...
        const addBundledTransactions = new requests.AddBundledTransactionsRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
    ...
    renewFioAddress() {
        ...
        const renewFioAddress = new requests.RenewFioAddressRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
    ...
    renewFioDomain() {
        ...
        const renewFioDomain = new requests.RenewFioDomainRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
    ...
    addPublicAddress() {
        ...
        const addPublicAddress = new requests.AddPublicAddressesRequest(this.config, Object.assign(Object.assign({}, args), { publicAddresses: [{
    ...
    cancelFundsRequest() {
        ...
        const cancelFundsRequest = new requests.CancelFundsRequestRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
    ...
    removePublicAddresses() {
        ...
        const removePublicAddresses = new requests.RemovePublicAddressesRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
    ...
    transferLockedTokens() {
        ...
        const transferLockedTokens = new requests.TransferLockedTokensRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
    ...
    removeAllPublicAddresses() {
        ...
        const removeAllPublicAddresses = new requests.RemoveAllPublicAddressesRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
    ...
    addPublicAddresses() {
        ...
        const addPublicAddress = new requests.AddPublicAddressesRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
        return addPublicAddress.execute(this.privateKey, this.publicKey, this.returnPreparedTrx);
    }
    setFioDomainVisibility() {
        ...
        const SetFioDomainVisibility = new requests.SetFioDomainVisibilityRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
    ...
    recordObtData(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const recordObtData = new requests.RecordObtDataRequest(this.config, Object.assign(Object.assign({}, args), { payeeFioPublicKey: (payeeEncryptKey === null || payeeEncryptKey === void 0 ? void 0 : payeeEncryptKey.encrypt_public_key) || args.payeeFioPublicKey, technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
    ...
    getObtData(options) {
        const args = (0, utils_1.cleanupObject)(options);
        const getObtDataRequest = new queries.ObtDataQuery(this.config, Object.assign(Object.assign({}, args), { fioPublicKey: this.publicKey, getEncryptKey: this.getEncryptKey }));
    ...
    rejectFundsRequest() {
        ...
        const rejectFundsRequest = new requests.RejectFundsRequestRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
    ...
    requestFunds(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const requestNewFunds = new requests.FundsRequestRequest(this.config, Object.assign(Object.assign({}, args), { payerFioPublicKey: (payerEncryptKey === null || payerEncryptKey === void 0 ? void 0 : payerEncryptKey.encrypt_public_key) || args.payerFioPublicKey, technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
            return requestNewFunds.execute(this.privateKey, this.publicKey, this.returnPreparedTrx);
        });
    }
    getLocks() {
        const args = (0, utils_1.resolveOptions)({ keys: ['fioPublicKey'], arguments });
        const getLocks = new queries.LocksQuery(this.config, args);
        return getLocks.execute(this.publicKey);
    }
    getAccount() {
        const args = (0, utils_1.resolveOptions)({ keys: ['actor'], arguments });
        const getAccount = new queries.AccountQuery(this.config, args);
        return getAccount.execute(this.publicKey);
    }
    isAvailable() {
        const args = (0, utils_1.resolveOptions)({ keys: ['fioName'], arguments });
    ...
    getFioAddresses() {
        const args = (0, utils_1.resolveOptions)({ keys: ['fioPublicKey', 'limit', 'offset'], arguments });
    ...
    getPendingFioRequests(options) {
        const args = (0, utils_1.cleanupObject)(options);
        const pendingFioRequests = new queries.PendingFioRequestsQuery(this.config, Object.assign(Object.assign({}, args), { fioPublicKey: this.publicKey, getEncryptKey: this.getEncryptKey.bind(this) }));
    ...
    getReceivedFioRequests(options) {
        const args = (0, utils_1.cleanupObject)(options);
        const receivedFioRequests = new queries.ReceivedFioRequestsQuery(this.config, Object.assign(Object.assign({}, args), { fioPublicKey: this.publicKey, getEncryptKey: this.getEncryptKey.bind(this) }));
    ...
    getSentFioRequests(options) {
        const args = (0, utils_1.cleanupObject)(options);
        const sentFioRequest = new queries.SentFioRequestsQuery(this.config, Object.assign(Object.assign({}, args), { fioPublicKey: this.publicKey, getEncryptKey: this.getEncryptKey.bind(this) }));
    ...
    getPublicAddresses() {
        const args = (0, utils_1.resolveOptions)({ keys: ['fioAddress', 'limit', 'offset'], arguments });
    ...
    getFioPublicAddress() {
        const { fioAddress } = (0, utils_1.resolveOptions)({ keys: ['fioAddress'], arguments });
    ...
    transferTokens() {
        ...
        const transferTokens = new requests.TransferTokensKeyRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
    ...
    getFeeForAddPublicAddress() {
        const { fioAddress } = (0, utils_1.resolveOptions)({ keys: ['fioAddress'], arguments });
        return this.getFee({ fioAddress, endPoint: entities_1.EndPoint.addPubAddress });
    }
    ...
    getFeeForRemovePublicAddresses() {
        const { fioAddress } = (0, utils_1.resolveOptions)({ keys: ['fioAddress'], arguments });
        return this.getFee({ fioAddress, endPoint: entities_1.EndPoint.removePubAddress });
    }
    getFeeForRemoveAllPublicAddresses() {
        const { fioAddress } = (0, utils_1.resolveOptions)({ keys: ['fioAddress'], arguments });
        return this.getFee({ fioAddress, endPoint: entities_1.EndPoint.removeAllPubAddresses });
    }
    ...
    getAccountPubKey() {
        const args = (0, utils_1.resolveOptions)({ keys: ['account'], arguments });
        const getAccountPubKey = new queries.AccountPubKeyQuery(this.config, args);
        return getAccountPubKey.execute(this.publicKey);
    }
    getEncryptKey() {
        const args = (0, utils_1.resolveOptions)({ keys: ['fioAddress'], arguments });
