...
class FIOSDK {
    ...
    /**
     * Transfer a FIO Domain on the FIO blockchain.
     *
     * @param fioDomain FIO Domain to transfer.
     * @param maxFee Maximum amount of SUFs the user is willing to pay for fee. Should be preceded by @ [getFee] for correct value.
     * @param technologyProviderId FIO Address of the wallet which generates this transaction.
     */
    ...
    //NEW
    /**
     * Transfer a FIO Address on the FIO blockchain.
     *
     * @param fioAddress FIO Address to transfer.
     * @param maxFee Maximum amount of SUFs the user is willing to pay for fee. Should be preceded by @ [getFee] for correct value.
     * @param technologyProviderId FIO Address of the wallet which generates this transaction.
     */
    ...
    genericAction(action, params) {
        switch (action) {
            ...
            case 'transferFioAddress':
                return this.transferFioAddress(params.fioAddress, params.maxFee, params.technologyProviderId);
            case 'transferFioDomain':
                return this.transferFioDomain(params.fioAddress, params.maxFee, params.technologyProviderId);
