...
class FIOSDK {
    ...
    genericAction(action, params) {
        switch (action) {
            ...
            case 'requestFunds':
                return this.requestFunds(params.payerFioAddress, params.payeeFioAddress, params.payeeTokenPublicAddress, params.amount, params.tokenCode, params.memo, params.maxFee, params.payeeFioPublicKey, params.walletFioAddress, params.hash, params.offlineUrl);
            case 'isAvailable':
