...
const requests = __importStar(require("./transactions/requests"));
...
class FIOSDK {
    ...
    static get abiMap() {
        return Request_1.Request.abiMap;
    }
    get transactions() {
        const request = new Request_1.Request(this.config);
        return {
            ...
            apply(target, scope, args) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    const setAbi = (accountName) => __awaiter(this, void 0, void 0, function* () {
                        const abi = Request_1.Request.abiMap.get(accountName);
                        if (abi) {
                            return abi;
                        }
                        const newAbi = yield this.main.getAbi({ accountName });
                        if (newAbi) {
                            Request_1.Request.abiMap.set(newAbi.account_name, newAbi);
                            return newAbi;
                        }
                        return;
                    });
    ...
    getAbi() {
        const args = (0, utils_1.resolveOptions)({ keys: ['accountName'], arguments });
