...
class FIOSDK {
    ...
    **/
     ...
     * @param expirationOffset Expiration time offset for this transaction in seconds. Default is 180 seconds. Increasing number of seconds gives transaction more lifetime term.
     */
    registerFioDomainAddress(fioAddress, isPublic, maxFee, technologyProviderId = null, expirationOffset) {
        const registerFioDomainAddress = new SignedTransactions.RegisterFioDomainAddress(fioAddress, maxFee, isPublic, null, this.getTechnologyProviderId(technologyProviderId));
     ...
     * @param expirationOffset Expiration time offset for this transaction in seconds. Default is 180 seconds. Increasing number of seconds gives transaction more lifetime term.
     */
    registerOwnerFioDomainAddress(fioAddress, isPublic, maxFee, ownerPublicKey, technologyProviderId = null, expirationOffset) {
        const registerFioDomainAddress = new SignedTransactions.RegisterFioDomainAddress(fioAddress, maxFee, isPublic, ownerPublicKey, this.getTechnologyProviderId(technologyProviderId));
        return registerFioDomainAddress.execute(this.privateKey, this.publicKey, this.returnPreparedTrx, expirationOffset);
    }
    /**
     ...
     */
    recordObtData({ amount, chainCode, encryptPrivateKey = null, fioRequestId = null, hash = null, maxFee, memo = null, obtId, offLineUrl = null, payeeFioAddress, payeeFioPublicKey = '', payeeTokenPublicAddress, payerFioAddress, payerTokenPublicAddress, status, technologyProviderId = null, tokenCode, }) {
        return __awaiter(this, void 0, void 0, function* () {
            let payeeKey = '';
     ...
     */
    getObtData({ limit, offset, tokenCode, includeEncrypted, encryptKeys }) {
     ...
     */
    requestFunds({ amount, chainCode, encryptPrivateKey = null, hash = null, maxFee, memo, offlineUrl = null, payeeFioAddress, payeeTokenPublicAddress, payerFioAddress, payerFioPublicKey = null, technologyProviderId = null, tokenCode, }) {
        return __awaiter(this, void 0, void 0, function* () {
            let payerKey = '';
     ...
     * @param offset First request from list to return. If omitted, 0 is assumed.
     */
    getPendingFioRequests({ limit, offset, encryptKeys }) {
     ...
     * @param includeEncrypted Set to true if you want to include not encrypted data in return.
     */
    getReceivedFioRequests({ limit, offset, includeEncrypted, encryptKeys, }) {
     ...
     * @param includeEncrypted Set to true if you want to include not encrypted data in return.
     */
    getSentFioRequests({ limit, offset, includeEncrypted, encryptKeys, }) {
     ...
     * @param offset First request from list to return. If omitted, 0 is assumed.
     */
    getCancelledFioRequests({ limit, offset, encryptKeys }) {
        ...
        switch (action) {
            ...
            case 'registerFioDomainAddress':
                if (params.ownerPublicKey) {
                    return this.registerOwnerFioDomainAddress(params.fioAddress, (_a = params.isPublic) !== null && _a !== void 0 ? _a : false, params.maxFee, params.ownerPublicKey, params.technologyProviderId, params.expirationOffset);
                }
                else {
                    return this.registerFioDomainAddress(params.fioAddress, (_b = params.isPublic) !== null && _b !== void 0 ? _b : false, params.maxFee, params.technologyProviderId, params.expirationOffset);
                }
