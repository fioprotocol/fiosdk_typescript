...
class FIOSDK {
     ...
     * @param technologyProviderId FIO Address of the wallet which generates this transaction.
     */
    removePublicAddress(fioAddress, publicAddresses, maxFee, technologyProviderId = null) {
        const removePublicAddress = new SignedTransactions.RemovePublicAddress(fioAddress, publicAddresses, maxFee, this.getTechnologyProviderId(technologyProviderId));
    ...
    /**
       ...
       * @param fioAddress FIO Address incurring the fee and owned by signer.
       */
    getFeeForRemovePublicAddress(fioAddress) {
    ...
    genericAction(action, params) {
        switch (action) {
            ...
            case 'removePublicAddress':
                return this.removePublicAddress(params.fioAddress, params.publicAddresses, params.maxFee, params.technologyProviderId);
