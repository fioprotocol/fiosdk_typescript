...
class FIOSDK {
    ...
    addPublicAddress(fioAddress, tokenCode, publicAddress, maxFee, walletFioAddress = null) {
        const addPublicAddress = new SignedTransactions.AddPublicAddress(fioAddress, tokenCode, publicAddress, maxFee, this.getWalletFioAddress(walletFioAddress));
    ...
    recordSend(fioRequestId, payerFIOAddress, payeeFIOAddress, payerTokenPublicAddress, payeeTokenPublicAddress, amount, tokenCode, status, obtId, maxFee, walletFioAddress = null, payeeFioPublicKey = null, memo = null, hash = null, offLineUrl = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const recordSend = new SignedTransactions.RecordSend(fioRequestId, payerFIOAddress, payeeFIOAddress, payerTokenPublicAddress, payeeTokenPublicAddress, amount, tokenCode, obtId, maxFee, status, this.getWalletFioAddress(walletFioAddress), payeeKey.public_address, memo, hash, offLineUrl);
    ...
    requestFunds(payerFioAddress, payeeFioAddress, payeePublicAddress, amount, tokenCode, memo, maxFee, payerFioPublicKey = null, walletFioAddress = null, hash, offlineUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const requestNewFunds = new SignedTransactions.RequestNewFunds(payerFioAddress, payerKey.public_address, payeeFioAddress, this.getWalletFioAddress(walletFioAddress), maxFee, payeePublicAddress, amount, tokenCode, memo, hash, offlineUrl);
