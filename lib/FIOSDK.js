...
class FIOSDK {
     ...
     */
    constructor(privateKey, publicKey, baseUrl, fetchjson, registerMockUrl = '', tpid = '') {
    ...
    registerFioAddress(fioAddress, maxFee, walletFioAddress = null) {
        const registerFioAddress = new SignedTransactions.RegisterFioAddress(fioAddress, maxFee, walletFioAddress !== null ? walletFioAddress : this.tpid);
    ...
    registerFioDomain(fioDomain, maxFee, walletFioAddress = null) {
        const registerFioDomain = new SignedTransactions.RegisterFioDomain(fioDomain, maxFee, walletFioAddress !== null ? walletFioAddress : this.tpid);
    ...
    renewFioAddress(fioAddress, maxFee, walletFioAddress = null) {
        const renewFioAddress = new SignedTransactions.RenewFioAddress(fioAddress, maxFee, walletFioAddress !== null ? walletFioAddress : this.tpid);
    ...
    renewFioDomain(fioDomain, maxFee, walletFioAddress = null) {
        const renewFioDomain = new SignedTransactions.RenewFioDomain(fioDomain, maxFee, walletFioAddress !== null ? walletFioAddress : this.tpid);
    ...
    addPublicAddress(fioAddress, tokenCode, publicAddress, maxFee, walletFioAddress = null) {
        const addPublicAddress = new SignedTransactions.AddPublicAddress(fioAddress, [{
            ...
            }], maxFee, walletFioAddress !== null ? walletFioAddress : this.tpid);
    ...
    addPublicAddresses(fioAddress, publicAddresses, maxFee, walletFioAddress = '') {
        const addPublicAddress = new SignedTransactions.AddPublicAddress(fioAddress, publicAddresses, maxFee, walletFioAddress !== null ? walletFioAddress : this.tpid);
        return addPublicAddress.execute(this.privateKey, this.publicKey);
    }
    /**
    ...
    setFioDomainVisibility(fioDomain, isPublic, maxFee, walletFioAddress = null) {
        const SetFioDomainVisibility = new SignedTransactions.SetFioDomainVisibility(fioDomain, isPublic, maxFee, walletFioAddress !== null ? walletFioAddress : this.tpid);
    ...
    recordObtData(fioRequestId, payerFIOAddress, payeeFIOAddress, payerTokenPublicAddress, payeeTokenPublicAddress, amount, tokenCode, status, obtId, maxFee, walletFioAddress = null, payeeFioPublicKey = null, memo = null, hash = null, offLineUrl = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const recordObtData = new SignedTransactions.RecordObtData(fioRequestId, payerFIOAddress, payeeFIOAddress, payerTokenPublicAddress, payeeTokenPublicAddress, amount, tokenCode, obtId, maxFee, status, walletFioAddress !== null ? walletFioAddress : this.tpid, payeeKey.public_address, memo, hash, offLineUrl);
    ...
    rejectFundsRequest(fioRequestId, maxFee, walletFioAddress = null) {
        const rejectFundsRequest = new SignedTransactions.RejectFundsRequest(fioRequestId, maxFee, walletFioAddress !== null ? walletFioAddress : this.tpid);
     ...
     * @param offlineUrl
     */
    requestFunds(payerFioAddress, payeeFioAddress, payeePublicAddress, amount, tokenCode, memo, maxFee, payerFioPublicKey = null, walletFioAddress = null, hash, offlineUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const requestNewFunds = new SignedTransactions.RequestNewFunds(payerFioAddress, payerKey.public_address, payeeFioAddress, walletFioAddress !== null ? walletFioAddress : this.tpid, maxFee, payeePublicAddress, amount, tokenCode, memo, hash, offlineUrl);
    ...
    transferTokens(payeeFioPublicKey, amount, maxFee, walletFioAddress = null) {
        const transferTokens = new SignedTransactions.TransferTokens(payeeFioPublicKey, amount, maxFee, walletFioAddress !== null ? walletFioAddress : this.tpid);
    ...
    genericAction(action, params) {
        switch (action) {
            ...
            case 'recordObtData':
                return this.recordObtData(params.fioRequestId, params.payerFIOAddress, params.payeeFIOAddress, params.payerTokenPublicAddress, params.payeeTokenPublicAddress, params.amount, params.tokenCode, params.status, params.obtId, params.maxFee, params.walletFioAddress, params.payerFioPublicKey, params.memo, params.hash, params.offLineUrl);
            case 'getObtData':
