...
class FIOSDK {
    ...
    addPublicAddress(fioAddress, tokenCode, publicAddress, maxFee, walletFioAddress = null) {
        const addPublicAddress = new SignedTransactions.AddPublicAddress(fioAddress, tokenCode, publicAddress, maxFee, walletFioAddress !== null ? walletFioAddress : this.tpid);
     ...
     * @param offlineUrl
     */
    recordSend(fioRequestId, payerFIOAddress, payeeFIOAddress, payerTokenPublicAddress, payeeTokenPublicAddress, amount, tokenCode, status, obtId, maxFee, walletFioAddress = null, payeeFioPublicKey = null, memo = null, hash = null, offLineUrl = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const recordSend = new SignedTransactions.RecordSend(fioRequestId, payerFIOAddress, payeeFIOAddress, payerTokenPublicAddress, payeeTokenPublicAddress, amount, tokenCode, obtId, maxFee, status, walletFioAddress !== null ? walletFioAddress : this.tpid, payeeKey.public_address, memo, hash, offLineUrl);
     ...
     */
    pushTransaction(action, account, data) {
