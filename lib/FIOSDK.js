...
class FIOSDK {
    ...
    registerFioAddress(fioAddress, maxFee, technologyProviderId = null) {
        const registerFioAddress = new SignedTransactions.RegisterFioAddress(fioAddress, maxFee, this.getTechnologyProviderId(technologyProviderId));
     ...
     * @param technologyProviderId FIO Address of the wallet which generates this transaction.
     */
    addPublicAddresses(fioAddress, publicAddresses, maxFee, technologyProviderId = '') {
