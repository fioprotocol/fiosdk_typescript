...
class FIOSDK {
     ...
     * @param walletFioAddress FIO Address of the wallet which generates this transaction.
     */
    addPublicAddress(fioAddress, chainCode, tokenCode, publicAddress, maxFee, walletFioAddress = null) {
     ...
     * @param offlineUrl
     */
    recordObtData(fioRequestId, payerFIOAddress, payeeFIOAddress, payerTokenPublicAddress, payeeTokenPublicAddress, amount, chainCode, tokenCode, status, obtId, maxFee, walletFioAddress = null, payeeFioPublicKey = null, memo = null, hash = null, offLineUrl = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const recordObtData = new SignedTransactions.RecordObtData(fioRequestId, payerFIOAddress, payeeFIOAddress, payerTokenPublicAddress, payeeTokenPublicAddress, amount, chainCode, tokenCode, obtId, maxFee, status, this.getWalletFioAddress(walletFioAddress), payeeKey.public_address, memo, hash, offLineUrl);
     ...
     * @param offlineUrl
     */
    requestFunds(payerFioAddress, payeeFioAddress, payeeTokenPublicAddress, amount, chainCode, tokenCode, memo, maxFee, payerFioPublicKey = null, walletFioAddress = null, hash, offlineUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const requestNewFunds = new SignedTransactions.RequestNewFunds(payerFioAddress, payerKey.public_address, payeeFioAddress, this.getWalletFioAddress(walletFioAddress), maxFee, payeeTokenPublicAddress, amount, chainCode, tokenCode, memo, hash, offlineUrl);
    ...
    getFeeForRejectFundsRequest(payeeFioAddress) {
        return this.getFee(EndPoint_1.EndPoint.rejectFundsRequest, payeeFioAddress);
    }
    /**
     *
     * @param fioAddress
    ...
    genericAction(action, params) {
        switch (action) {
            ...
            case 'addPublicAddress':
                return this.addPublicAddress(params.fioAddress, params.chainCode, params.tokenCode, params.publicAddress, params.maxFee, params.walletFioAddress);
            ...
            case 'recordObtData':
                return this.recordObtData(params.fioRequestId || null, params.payerFIOAddress, params.payeeFIOAddress, params.payerTokenPublicAddress, params.payeeTokenPublicAddress, params.amount, params.chainCode, params.tokenCode, params.status || '', params.obtId, params.maxFee, params.walletFioAddress, params.payeeFioPublicKey, params.memo, params.hash, params.offLineUrl);
            case 'getObtData':
            ...
            case 'requestFunds':
                return this.requestFunds(params.payerFioAddress, params.payeeFioAddress, params.payeeTokenPublicAddress, params.amount, params.chainCode, params.tokenCode, params.memo, params.maxFee, params.payerFioPublicKey, params.walletFioAddress, params.hash, params.offlineUrl);
            case 'isAvailable':
