...
class FIOSDK {
    ...
    addBundledTransactions() {
        ...
        const addBundledTransactions = new requests.AddBundledRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
    ...
    transferTokens() {
        ...
        const transferTokens = new requests.TransferTokensRequest(this.config, Object.assign(Object.assign({}, args), { technologyProviderId: this.getTechnologyProviderId(args.technologyProviderId) }));
