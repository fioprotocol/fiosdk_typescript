...
class FIOSDK {
    ...
    static isTokenCodeValid(tokenCode) {
        const validation = (0, validation_1.validate)({ tokenCode }, { tokenCode: validation_1.allRules.tokenCode });
        if (!validation.isValid) {
     ...
     * @param preparedTrx
     */
    executePreparedTrx(endPoint_1, preparedTrx_1) {
        return __awaiter(this, arguments, void 0, function* (endPoint, preparedTrx, returnBaseUrl = false) {
    ...
    pushTransaction(options) {
        return __awaiter(this, void 0, void 0, function* () {
            const { account, action, data, authPermission, encryptOptions = {}, signingAccount, expirationOffset, } = (0, utils_1.cleanupObject)(options);
