 ...
 */
function binaryToDecimal(bignum, minDigits = 1) {
 ...
 * @param minDigits 0-pad result to this many digits
 */
function signedBinaryToDecimal(bignum, minDigits = 1) {
 ...
 * @param minDigits 0-pad result to this many digits
 */
function binaryToBase58(bignum, minDigits = 1) {
    const result = [];
...
function stringToPublicKey(s) {
    ...
    if (s.substr(0, 3) === 'FIO') {
        const whole = base58ToBinary(exports.publicKeyDataSize + 4, s.substr(3));
