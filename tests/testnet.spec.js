...
describe('Encrypting/Decrypting', () => {
  ...
  it(`Encrypt/Decrypt - Request New Funds`, async () => {
    ...
    // console.log(cipherContent)

    // UKPHFo0xs3GwGAXMc44QqkDtj7dcbGHjU3cJmN1qiYWADvzyd9pen2WwKn0VZtk0ZTGFXpap7Id8nZxlCMK7TjkabO85XNbhausE4ZZzx3hm25bqV2GDRHpRomsRDGAzLbFEumsm+4UNBtnOqUK3Kuo91vKjlLIV3NoF83qOSbhL8QDqV2N/yJxSu4PsiDeqhhSypZx8McaubVoUueioWA==
    ...
    try {
      ...
      console.log(uncipherContentSameParty)
    ...
    try {
      ...
      console.log(uncipherContentNonParty)
    ...
    try {
      ...
      console.log(uncipherContentNonPartyA)
