...
let privateKey = process.env.LOCAL_PRIVATE_KEY as string
let publicKey = process.env.LOCAL_PUBLIC_KEY as string
let privateKey2 = process.env.LOCAL_PRIVATE_KEY_2 as string
let publicKey2 = process.env.LOCAL_PUBLIC_KEY_2 as string
let testFioAddressName = process.env.LOCAL_TEST_FIO_ADDRESS_NAME as string
let testFioAddressName2 = process.env.LOCAL_TEST_FIO_ADDRESS_NAME_2 as string
let testFioDomainName = process.env.LOCAL_TEST_FIO_DOMAIN_NAME as string

let encPrivateKey = process.env.LOCAL_ENC_PRIVATE_KEY as string
let encPublicKey = process.env.LOCAL_ENC_PUBLIC_KEY as string
let encPrivateKey2 = process.env.LOCAL_ENC_PRIVATE_KEY_2 as string
let encPublicKey2 = process.env.LOCAL_ENC_PUBLIC_KEY_2 as string
let encTestFioAddressName = process.env.LOCAL_ENC_TEST_FIO_ADDRESS_NAME as string
let encTestFioAddressName2 = process.env.LOCAL_ENC_TEST_FIO_ADDRESS_NAME_2 as string
...
before(async () => {
    ...
    await fioSdkFaucet.transferTokens(encPublicKey, fundAmount * 4, defaultFee)
    await fioSdkFaucet.transferTokens(encPublicKey2, fundAmount * 4, defaultFee)
...
describe('Testing generic actions', () => {
    ...
    const pubKeyForTransfer = FIOSDK.derivedPublicKey('5HvaoRV9QrbbxhLh6zZHqTzesFEG5vusVJGbUazFi5xQvKMMt6U').publicKey
